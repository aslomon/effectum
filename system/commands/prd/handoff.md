...
description: "Export a completed PRD as a full handoff package (HANDOFF.md + tasks.md + PLAN.md). Use --prompt-only to just generate the handoff prompt without writing files."
allowed-tools: ["Read", "Write", "Bash"]
effort: "medium"
---

> ⚠️ **`/prd:handoff` is deprecated → use `/effect:prd:handoff`** (removed in v0.20)
