...
These slash commands are available in your agent workflow for **{{projectName}}**:
...
| `effect:dev:plan`        | Generate a step-by-step implementation plan before coding |
| `effect:dev:tdd`         | Write tests first, then implement to make them pass       |
| `effect:dev:verify`      | Run all tests and checks; report status                   |
| `effect:dev:review`      | Review recent changes for correctness and style           |
